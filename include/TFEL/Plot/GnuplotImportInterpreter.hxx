...
#ifndef LIB_TFEL_PLOT_GNUPLOTIMPORTINTERPRETER_HXX
#define LIB_TFEL_PLOT_GNUPLOTIMPORTINTERPRETER_HXX
  ...
  namespace plot {
    ...
    struct GnuplotInterpreter::ImportInterpreter
     ...
     protected:
      ...
      void importCyranoFunction(const std::string&,
                                const std::string&,
                                const unsigned short,
                                const bool);
...
#endif /* LIB_TFEL_PLOT_GNUPLOTIMPORTINTERPRETER_HXX */
