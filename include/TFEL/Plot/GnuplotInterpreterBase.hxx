  ...
  namespace plot {
    ...
    struct TFELGNUPLOTINTERPRETER_VISIBILITY_EXPORT
     ...
     protected:
       ...
       * by the interpreter
       */
      GnuplotInterpreterBase(Graph&, QObject* const = nullptr);
      ...
      static void throwKeyAlreadyRegistredCallBack(const std::string&);
      ...
      static void readVariableList(std::vector<std::string>&,
                                   const_iterator&,
