...
namespace tfel
{
  ...
  namespace plot
  {
    ...
    class TFELPLOT_VISIBILITY_EXPORT Graph
    ...
    public slots:
      ...
      virtual void setGrid(const unsigned short,
			   const bool = true);
      ...
      virtual void removeArrow(const QString&,
			       const bool = true);
      ...
      virtual void setX2Label(const QString&,
			      const bool = true);
      
      virtual void setY2Label(const QString&,
			      const bool = true);
      
      virtual void setUpperTitle(const QString&,
				 const bool = true);
      
      virtual void setDownTitle(const QString&,
				const bool = true);
      
      virtual void setRightTitle(const QString&,
				 const bool = true);
      
      virtual void setLeftTitle(const QString&,
				const bool = true);
      ...
      virtual void setYRange(const qreal,const qreal,
			     const bool = true);
      
      virtual void setX2Range(const qreal,const qreal,
			      const bool = true);
      
      virtual void setY2Range(const qreal,const qreal,
			      const bool = true);
      ...
      virtual void removeLabel(const QString&,
			       const bool = true);
	...
	GraphAxis axis;
       ...
       */
      void setTheme(const std::shared_ptr<GraphTheme>&,
		    const bool);
    ...
    protected:
      ...
      findLabel(const QString&);
      QVector<std::shared_ptr<Graph::Arrow> >::iterator
      findArrow(const QString&);
      QVector<CurveHandler>::iterator
      findCurveHandler(Curve *const);
      ...
      void plot(QGraphicsScene&,
		...
		const unsigned short);
      QString
      convertToString(const qreal);
      QString
      convertTicsToString(const qreal,
      ...
      computePoints(CurveHandler&,
		    ...
		    const qreal);
      void
      computeRange(qreal&,qreal&,const unsigned short);
      void
      computeRange2(qreal&,qreal&,const unsigned short);
      qreal
      computeTicsIncrements(const qreal,
			    const qreal) const;
      void
      insertIntoTics(QMap<qreal,QString>&,
		     const qreal,
		     const qreal);
      void
      computeLinearScaleTics(Graph::Axis&);
      void
      computeLogScaleTics(QMap<qreal,QString>&,
			  qreal&,
			  qreal&);
      void
      computeTics(Graph::Axis&);
      void
      computeGraphLayout(const qreal,
			 const qreal,
			 GraphLayout&);
