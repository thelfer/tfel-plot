...
namespace tfel
{
  ...
  namespace plot
  {
     ...
     */
    struct GnuplotInterpreter::SetInterpreter
      : GnuplotInterpreterBase
    {
       ...
       * \param[in] g: graph
       */
      SetInterpreter(GnuplotInterpreter&,
		     Graph&);
      /*!
    ...
    protected:
       ...
       * \param[in]     pe: end of current instruction
       */
      void treatBorder(const_iterator&, 
		       const const_iterator);
      /*!
       ...
       * \param[in]     pe: end of current instruction
       */
      void treatNoBorder(const_iterator&, 
			 const const_iterator);
      /*!
       ...
       * \param[in]     pe: end of current instruction
       */
      void treatOutput(const_iterator&, 
		       const const_iterator);
      /*!
       ...
       * \param[in]     pe: end of current instruction
       */
      void treatTerminal(const_iterator&, 
			 const const_iterator);
      /*!
       ...
       * \param[in]     pe: end of current instruction
       */
      void treatArrow(const_iterator&, 
		      const const_iterator);
      /*!
       ...
       * \param[in]     pe: end of current instruction
       */
      void treatTitle(const_iterator&, 
		      const const_iterator);
      /*!
       ...
       * \param[in]     pe: end of current instruction
       */
      void treatTheme(const_iterator&, 
		      const const_iterator);
      /*!
       ...
       * \param[in]     pe: end of current instruction
       */
      void treatDummy(const_iterator&, 
		      const const_iterator);
      /*!
       ...
       * \param[in]     pe: end of current instruction
       */
      void treatCurve(const_iterator&, 
		      const const_iterator);
      /*!
       ...
       * \param[in]     pe: end of current instruction
       */
      QMap<qreal,QString> treatTics(const_iterator&, 
				    const const_iterator);
