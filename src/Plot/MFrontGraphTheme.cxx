...
namespace tfel {
  ...
  namespace plot {
    ...
    struct MFrontGraphTheme : public StandardGraphTheme {
      void getGraphBorders(
          Graph& g, qreal& gl, qreal& gr, qreal& gu, qreal& gd) const override {
    ...
    StandardThemeProxy<MFrontGraphTheme> MFrontGraphThemeProxy(
        "MFrontGraphTheme");
