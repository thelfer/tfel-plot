...
namespace tfel {
  ...
  namespace plot {
    ...
    void GnuplotInterpreter::SetInterpreter::treatNoBorder(
        const_iterator&, const const_iterator) {
      this->g.hideBorder(true);
    }

    void GnuplotInterpreter::SetInterpreter::treatCurve(
        const_iterator& p, const const_iterator pe) {
      using namespace std;
      CxxTokenizer::checkNotEndOfLine(
    ...
    void GnuplotInterpreter::SetInterpreter::treatXLabel(
        const_iterator& p, const const_iterator pe) {
      using namespace std;
      CxxTokenizer::checkNotEndOfLine(
    ...
    void GnuplotInterpreter::SetInterpreter::treatX2Label(
        const_iterator& p, const const_iterator pe) {
      using namespace std;
      CxxTokenizer::checkNotEndOfLine(
          "GnuplotInterpreter::SetInterpreter::treatX2label",
          "expected label name", p, pe);
      this->g.setX2Label(this->readQString(p, pe), true);
    }  // end of GnuplotInterpreter::SetInterpreter::treatX2Label

    void GnuplotInterpreter::SetInterpreter::treatYLabel(
        const_iterator& p, const const_iterator pe) {
      using namespace std;
      CxxTokenizer::checkNotEndOfLine(
          "GnuplotInterpreter::SetInterpreter::treatYlabel",
          "expected label name", p, pe);
      this->g.setYLabel(this->readQString(p, pe), true);
    }  // end of GnuplotInterpreter::SetInterpreter::treatYLabel

    void GnuplotInterpreter::SetInterpreter::treatY2Label(
        const_iterator& p, const const_iterator pe) {
      using namespace std;
      CxxTokenizer::checkNotEndOfLine(
          "GnuplotInterpreter::SetInterpreter::treatY2label",
          "expected label name", p, pe);
      this->g.setY2Label(this->readQString(p, pe), true);
    }  // end of GnuplotInterpreter::SetInterpreter::treatY2Label

    void GnuplotInterpreter::SetInterpreter::treatOutput(
        const_iterator& p, const const_iterator pe) {
      CxxTokenizer::checkNotEndOfLine(
          "GnuplotInterpreter::SetInterpreter::treatOutput",
    ...
    void GnuplotInterpreter::SetInterpreter::treatTerminal(
        const_iterator& p, const const_iterator pe) {
      std::vector<std::string> options;
      CxxTokenizer::checkNotEndOfLine(
          "GnuplotInterpreter::SetInterpreter::treatTerminal",
    ...
    void GnuplotInterpreter::SetInterpreter::treatGrid(
        const_iterator& p, const const_iterator pe) {
      using namespace std;
    ...
    void GnuplotInterpreter::SetInterpreter::treatXRange(
        const_iterator& p, const const_iterator pe) {
      using namespace tfel::math::parser;
      CxxTokenizer::checkNotEndOfLine(
          "GnuplotInterpreter::SetInterpreter::treatXRange", "", p, pe);
      if (p->value == "auto") {
        this->g.unsetXRange();
        ++p;
      } else {
    ...
    void GnuplotInterpreter::SetInterpreter::treatX2Range(
        const_iterator& p, const const_iterator pe) {
      using namespace tfel::math::parser;
      CxxTokenizer::checkNotEndOfLine(
          "GnuplotInterpreter::SetInterpreter::treatXRange", "", p, pe);
    ...
    void GnuplotInterpreter::SetInterpreter::treatYRange(
        const_iterator& p, const const_iterator pe) {
      using namespace tfel::math::parser;
      CxxTokenizer::checkNotEndOfLine(
          "GnuplotInterpreter::SetInterpreter::treatXRange", "", p, pe);
    ...
    void GnuplotInterpreter::SetInterpreter::treatY2Range(
        const_iterator& p, const const_iterator pe) {
      using namespace tfel::math::parser;
      CxxTokenizer::checkNotEndOfLine(
          "GnuplotInterpreter::SetInterpreter::treatXRange", "", p, pe);
    ...
    void GnuplotInterpreter::SetInterpreter::treatLogScale(
      ...
      if (p->value == "x") {
        ...
        throw(std::runtime_error(
            "GnuplotInterpreter::SetInterpreter::treatLogScale: "
            "unknown axis '" +
            p->value + "'"));
      }
      ++p;
    ...
    void GnuplotInterpreter::SetInterpreter::treatXTics(
        const_iterator& p, const const_iterator pe) {
      CxxTokenizer::checkNotEndOfLine(
          "GnuplotInterpreter::SetInterpreter::treatXTics", "", p, pe);
      if (p->value == "auto") {
        this->g.unsetXTics();
      } else {
    ...
    void GnuplotInterpreter::SetInterpreter::treatX2Tics(
        const_iterator& p, const const_iterator pe) {
      CxxTokenizer::checkNotEndOfLine(
          "GnuplotInterpreter::SetInterpreter::treatX2Tics", "", p, pe);
      if (p->value == "auto") {
        this->g.unsetX2Tics();
      } else {
    ...
    void GnuplotInterpreter::SetInterpreter::treatYTics(
        const_iterator& p, const const_iterator pe) {
      CxxTokenizer::checkNotEndOfLine(
          "GnuplotInterpreter::SetInterpreter::treatYTics", "", p, pe);
      if (p->value == "auto") {
        this->g.unsetYTics();
      } else {
    ...
    void GnuplotInterpreter::SetInterpreter::treatY2Tics(
        const_iterator& p, const const_iterator pe) {
      CxxTokenizer::checkNotEndOfLine(
          "GnuplotInterpreter::SetInterpreter::treatY2Tics", "", p, pe);
      if (p->value == "auto") {
        this->g.unsetY2Tics();
      } else {
      ...
      while (p->value != ")") {
        ...
        if (vars.size() != 0) {
          ...
          if (vars.size() != 1u) {
            ...
            msg << "GnuplotInterpreter::SetInterpreter::treatSetTics : "
                   "invalid print declaration (unknown variable "
                << vars[0] << ")";
          }
    ...
    void GnuplotInterpreter::SetInterpreter::treatTheme(
        const_iterator& p, const const_iterator pe) {
      using namespace tfel::utilities;
      CxxTokenizer::checkNotEndOfLine(
    ...
    void GnuplotInterpreter::SetInterpreter::treatArrow(
        const_iterator& p, const const_iterator pe) {
      using namespace std;
      string name;
      ArrowStyle style;
      CxxTokenizer::checkNotEndOfLine(
          "GnuplotInterpreter::SetInterpreter::treatArrow", "", p, pe);
      if (p->value != "from") {
        name = p->value;
