...
namespace tfel {
  ...
  namespace plot {
    ...
    void GnuplotInterpreter::UnSetInterpreter::treatLabel(
    ...
    void GnuplotInterpreter::UnSetInterpreter::treatLogScale(
        const_iterator& p, const const_iterator pe) {
      using namespace std;
      CxxTokenizer::checkNotEndOfLine(
          "GnuplotInterpreter::UnSetInterpreter::treatLogScale", "", p, pe);
      if (p->value == "x") {
    ...
    void GnuplotInterpreter::UnSetInterpreter::eval(const_iterator& p,
      ...
      using namespace std;
      CxxTokenizer::checkNotEndOfLine(
          "GnuplotInterpreter::UnSetInterpreter::eval", "", p, pe);
    ...
    void GnuplotInterpreter::UnSetInterpreter::treatXRange(
        const_iterator&, const const_iterator) {
      this->g.unsetXRange();
    }  // end of GnuplotInterpreter::UnSetInterpreter::treatXRange

    void GnuplotInterpreter::UnSetInterpreter::treatX2Range(
        const_iterator&, const const_iterator) {
      this->g.unsetX2Range();
    }  // end of GnuplotInterpreter::UnSetInterpreter::treatXRange

    void GnuplotInterpreter::UnSetInterpreter::treatYRange(
        const_iterator&, const const_iterator) {
      this->g.unsetYRange();
    }  // end of GnuplotInterpreter::UnSetInterpreter::treatYRange

    void GnuplotInterpreter::UnSetInterpreter::treatY2Range(
        const_iterator&, const const_iterator) {
      this->g.unsetY2Range();
    }  // end of GnuplotInterpreter::UnSetInterpreter::treatY2Range

    void GnuplotInterpreter::UnSetInterpreter::treatXLabel(
        const_iterator&, const const_iterator) {
      this->g.setXLabel("");
    }  // end of GnuplotInterpreter::UnSetInterpreter::treatXLabel

    void GnuplotInterpreter::UnSetInterpreter::treatX2Label(
        const_iterator&, const const_iterator) {
      this->g.setX2Label("");
    }  // end of GnuplotInterpreter::UnSetInterpreter::treatX2Label

    void GnuplotInterpreter::UnSetInterpreter::treatYLabel(
        const_iterator&, const const_iterator) {
      this->g.setYLabel("");
    }  // end of GnuplotInterpreter::UnSetInterpreter::treatYLabel

    void GnuplotInterpreter::UnSetInterpreter::treatY2Label(
        const_iterator&, const const_iterator) {
      this->g.setY2Label("");
    ...
    void GnuplotInterpreter::UnSetInterpreter::treatXTics(
        const_iterator&, const const_iterator) {
      this->g.unsetXTics();
    }  // end of GnuplotInterpreter::UnSetInterpreter::treatXTics

    void GnuplotInterpreter::UnSetInterpreter::treatX2Tics(
        const_iterator&, const const_iterator) {
      this->g.unsetX2Tics();
    }  // end of GnuplotInterpreter::UnSetInterpreter::treatXTics

    void GnuplotInterpreter::UnSetInterpreter::treatYTics(
        const_iterator&, const const_iterator) {
      this->g.unsetYTics();
    }  // end of GnuplotInterpreter::UnSetInterpreter::treatXTics

    void GnuplotInterpreter::UnSetInterpreter::treatY2Tics(
        const_iterator&, const const_iterator) {
      this->g.unsetY2Tics();
    }  // end of GnuplotInterpreter::UnSetInterpreter::treatXTics
