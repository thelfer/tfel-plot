...
namespace tfel {
  ...
  namespace plot {
    ...
    const qreal StandardGraphTheme::defaultRedColors[10] = {
        255., 112., 255., 20., 204., 140., 0., 125., 0., 0.};
    const qreal StandardGraphTheme::defaultGreenColors[10] = {
        179., 188., 0., 30., 0., 120., 160., 0., 60., 0.};
    const qreal StandardGraphTheme::defaultBlueColors[10] = {
        16., 16., 0., 255., 192., 80., 160., 0., 0., 125.};

    const unsigned short StandardGraphTheme::defaultColorsNumber = 10u;
    ...
    void StandardGraphTheme::getGraphBorders(
        Graph&, qreal& gl, qreal& gr, qreal& gu, qreal& gd) const {
      gl = 6u;
      gr = 6u;
      gu = 6u;
      gd = 6u;
    ...
    void StandardGraphTheme::printXLabel(Graph& g,
                                         const GraphLayout& l,
                                         const GraphSize& s,
    ...
    void StandardGraphTheme::printYLabel(Graph& g,
                                         const GraphLayout& l,
                                         const GraphSize& s,
                                         const QString& ylabel) const {
      auto& cr = g.getScene();
      auto* t = new GraphTextItem(ylabel, &g, &Graph::setYLabel);
      t->setRotation(-90.);
      const auto b = t->boundingRect();
    ...
    void StandardGraphTheme::printXTics(
        Graph& g,
        const GraphLayout& l,
        const GraphSize& s,
    ...
    void StandardGraphTheme::printYTics(
        Graph& g,
        const GraphLayout& l,
        const GraphSize&,
    ...
    void StandardGraphTheme::printX2Tics(
        Graph& g,
        const GraphLayout& l,
        const GraphSize&,
    ...
    void StandardGraphTheme::printY2Tics(
        Graph& g,
        const GraphLayout& l,
        const GraphSize& s,
    ...
    void StandardGraphTheme::printUpperTitle(Graph& g,
                                             const GraphLayout& l,
                                             const GraphSize& s,
    ...
    void StandardGraphTheme::printDownTitle(Graph& g,
                                            const GraphLayout& l,
                                            const GraphSize& s,
                                            const QString& t) const {
      auto& cr = g.getScene();
    ...
    void StandardGraphTheme::printLeftTitle(Graph& g,
                                            const GraphLayout& l,
                                            const GraphSize& s,
                                            const QString& t) const {
      auto& cr = g.getScene();
    ...
    void StandardGraphTheme::printRightTitle(Graph& g,
                                             const GraphLayout& l,
                                             const GraphSize& s,
                                             const QString& t) const {
      auto& cr = g.getScene();
    ...
    void StandardGraphTheme::drawForeGround(Graph&,
                                            const GraphLayout&,
                                            const GraphSize&) const {
    }  // end of StandardGraphTheme::drawForeGround

    void StandardGraphTheme::drawBackGround(Graph& g,
                                            const GraphLayout&,
                                            const GraphSize&) const {
      auto& cr = g.getScene();
    ...
    void StandardGraphTheme::drawYAxis(QGraphicsItem& d,
                                       const GraphLayout& l,
                                       const GraphSize& s) const {
      QPainterPath path;
      QPen pen;
    ...
    void StandardGraphTheme::drawGraphBorder(Graph& g,
                                             const GraphLayout&,
                                             const GraphSize& s) const {
      const qreal w = 2.0;
      QPen pen;
    ...
    void StandardGraphTheme::drawHorizontalGrid(
        Graph& g,
        const QPen& pen,
        const GraphLayout& l,
        const GraphSize& s,
    ...
    void StandardGraphTheme::drawVerticalGrid(
        Graph& g,
        const QPen& pen,
        const GraphLayout& l,
        const GraphSize& s,
    ...
    void StandardGraphTheme::drawHorizontalGridMark(
        Graph& g,
        const QPen& pen,
        const GraphLayout& l,
        const GraphSize& s,
    ...
    void StandardGraphTheme::drawVerticalGridMark(
        Graph& g,
        const QPen& pen,
        const GraphLayout& l,
        const GraphSize& s,
    ...
    void StandardGraphTheme::drawCurveWithTriangles(
        Graph& g,
        QGraphicsItem& d,
        Curve* const curve,
        const std::vector<Point>& pts,
    ...
    void StandardGraphTheme::drawCurveWithDiamonds(
        Graph& g,
        QGraphicsItem& d,
        Curve* const curve,
        const std::vector<Point>& pts,
    ...
    Curve::Style StandardGraphTheme::getCurveStyleFromThemeStyle(
        const unsigned short t) const {
      return Curve::intToCurveStyle(t % 3);
    }  // end of StandardGraphTheme::getCurveStyleFromThemeStyle

    QColor StandardGraphTheme::getCurveColorFromThemeStyle(
        const unsigned short t) const {
    ...
    void StandardGraphTheme::drawCurve(Graph& g,
                                       QGraphicsItem& d,
                                       Curve* const c,
                                       const std::vector<Point>& pts,
                                       const GraphSize&,
    ...
    void StandardGraphTheme::printKeys(Graph& g,
      ...
      std::vector<Graph::CurveHandler>::iterator p;
    ...
    void StandardGraphTheme::drawCurveKey(QGraphicsItemGroup& gr,
                                          const QColor& c,
                                          const Curve::Style style,
                                          const qreal xh,
                                          const qreal yh,
    ...
    void StandardGraphTheme::printLabel(Graph&,
                                        const qreal,
                                        const qreal,
                                        const QString&) const {
      // cr->save();
