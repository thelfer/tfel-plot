...
namespace tfel {
  ...
  namespace plot {
    ...
    CurveConfigurationDialog::CurveConfigurationDialog(Curve* const c,
                                                       QWidget* const p)
        : CurveConfigurationDialogBase(p), curve(c) {
      this->createCurveColorButton();
      this->setLayout(this->cl);
      this->setAttribute(Qt::WA_DeleteOnClose);
      QObject::connect(this->curve, &Curve::destroyed, this,
                       &CurveConfigurationDialog::close);
      ...
      QObject::connect(this->ke, &QLineEdit::textChanged, this,
                       &CurveConfigurationDialog::keyChanged);
      QObject::connect(this->curve, &Curve::keyChanged, this,
                       &CurveConfigurationDialog::curveKeyChanged);
      QObject::connect(this->cd, &QColorDialog::currentColorChanged, this,
                       &CurveConfigurationDialog::newColorSelected);
      QObject::connect(this->curve, &Curve::colorChanged, this,
                       &CurveConfigurationDialog::curveColorChanged);
      ...
      QObject::connect(this->curve, &Curve::styleChanged, this,
                       &CurveConfigurationDialog::curveStyleChanged);
      QObject::connect(this->scb,
                       static_cast<void (QComboBox::*)(int)>(
                           &QComboBox::currentIndexChanged),
                       this, &CurveConfigurationDialog::styleChanged);
      QObject::connect(this->ws, &QSlider::valueChanged, this,
                       &CurveConfigurationDialog::widthChanged);
      QObject::connect(this->curve, &Curve::widthChanged, this->ws,
                       &QSlider::setValue);
    }

    void CurveConfigurationDialog::keyChanged(const QString& k) {
      QObject::disconnect(this->curve, &Curve::keyChanged, this,
                          &CurveConfigurationDialog::curveKeyChanged);
    ...
    void CurveConfigurationDialog::styleChanged(int i) {
      QObject::disconnect(this->curve, &Curve::styleChanged, this,
                          &CurveConfigurationDialog::curveStyleChanged);
    ...
    void CurveConfigurationDialog::widthChanged(int w) {
      QObject::disconnect(this->curve, &Curve::widthChanged, this->ws,
                          &QSlider::setValue);
    ...
    void CurveConfigurationDialog::chooseCurveColor() {
      ...
      if (cd->exec() == QDialog::Accepted) {
        QObject::disconnect(this->curve, &Curve::colorChanged, this,
                            &CurveConfigurationDialog::curveColorChanged);
      ...
      QObject::disconnect(this->cd, &QColorDialog::currentColorChanged, this,
                          &CurveConfigurationDialog::newColorSelected);
    }
    ...
    void CurveConfigurationDialog::createCurveColorButton() {
      ...
      QObject::connect(cb, &QPushButton::clicked, this,
                       &CurveConfigurationDialog::chooseCurveColor);
      if (this->curve->hasSpecifiedColor()) {
