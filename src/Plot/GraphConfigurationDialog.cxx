...
namespace tfel {
  ...
  namespace plot {
    ...
    QWidget* GraphConfigurationDialog::createLabelsPage() {
      ...
      QObject::connect(&(this->graph), &Graph::xLabelChanged, this,
                       &GraphConfigurationDialog::graphXLabelChanged);
      QObject::connect(this->xle, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::xLabelChanged);
      grid->addWidget(new QLabel(tr("y-axis label")), 1, 0);
      grid->addWidget(this->yle, 1, 1);
      QObject::connect(&(this->graph), &Graph::yLabelChanged, this,
                       &GraphConfigurationDialog::graphYLabelChanged);
      QObject::connect(this->yle, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::yLabelChanged);
      grid->addWidget(new QLabel(tr("x2-axis label")), 2, 0);
      grid->addWidget(this->x2le, 2, 1);
      QObject::connect(&(this->graph), &Graph::x2LabelChanged, this,
                       &GraphConfigurationDialog::graphX2LabelChanged);
      QObject::connect(this->x2le, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::x2LabelChanged);
      grid->addWidget(new QLabel(tr("y2-axis label")), 3, 0);
      grid->addWidget(this->y2le, 3, 1);
      QObject::connect(&(this->graph), &Graph::y2LabelChanged, this,
                       &GraphConfigurationDialog::graphY2LabelChanged);
      QObject::connect(this->y2le, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::y2LabelChanged);
    ...
    QWidget* GraphConfigurationDialog::createRangesPage() {
      ...
      QObject::connect(&(this->graph), &Graph::xRangeChanged, this,
                       &GraphConfigurationDialog::graphXRangeChanged);
      QObject::connect(this->xmin, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::xMinRangeChanged);
      QObject::connect(this->xmax, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::xMaxRangeChanged);
      // y axis
      ...
      QObject::connect(&(this->graph), &Graph::yRangeChanged, this,
                       &GraphConfigurationDialog::graphYRangeChanged);
      QObject::connect(this->ymin, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::yMinRangeChanged);
      QObject::connect(this->ymax, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::yMaxRangeChanged);
      // x2 axis
      ...
      QObject::connect(&(this->graph), &Graph::x2RangeChanged, this,
                       &GraphConfigurationDialog::graphX2RangeChanged);
      QObject::connect(this->x2min, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::x2MinRangeChanged);
      QObject::connect(this->x2max, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::x2MaxRangeChanged);
      // y2 axis
      ...
      QObject::connect(&(this->graph), &Graph::y2RangeChanged, this,
                       &GraphConfigurationDialog::graphY2RangeChanged);
      QObject::connect(this->y2min, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::y2MinRangeChanged);
      QObject::connect(this->y2max, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::y2MaxRangeChanged);
      ranges->setLayout(grid);
      return ranges;
    }

    void GraphConfigurationDialog::xMinRangeChanged(const QString& v) {
      QObject::disconnect(&(this->graph), &Graph::xRangeChanged, this,
                          &GraphConfigurationDialog::graphXRangeChanged);
      bool b;
      qreal vmin;
      qreal vmax;
    ...
    void GraphConfigurationDialog::graphXRangeChanged(const qreal vmin,
                                                      const qreal vmax) {
      QObject::disconnect(this->xmin, &QLineEdit::textChanged, this,
                          &GraphConfigurationDialog::xMinRangeChanged);
      QObject::disconnect(this->xmax, &QLineEdit::textChanged, this,
                          &GraphConfigurationDialog::xMaxRangeChanged);
    ...
    void GraphConfigurationDialog::yMinRangeChanged(const QString& v) {
      QObject::disconnect(&(this->graph), &Graph::yRangeChanged, this,
                          &GraphConfigurationDialog::graphYRangeChanged);
      bool b;
      qreal vmin;
      qreal vmax;
    ...
    void GraphConfigurationDialog::graphYRangeChanged(const qreal vmin,
                                                      const qreal vmax) {
      QObject::disconnect(this->ymin, &QLineEdit::textChanged, this,
                          &GraphConfigurationDialog::yMinRangeChanged);
      QObject::disconnect(this->ymax, &QLineEdit::textChanged, this,
                          &GraphConfigurationDialog::yMaxRangeChanged);
    ...
    void GraphConfigurationDialog::x2MinRangeChanged(const QString& v) {
      QObject::disconnect(&(this->graph), &Graph::x2RangeChanged, this,
                          &GraphConfigurationDialog::graphX2RangeChanged);
      bool b;
      qreal vmin;
      qreal vmax;
    ...
    void GraphConfigurationDialog::graphX2RangeChanged(const qreal vmin,
                                                       const qreal vmax) {
      QObject::disconnect(this->x2min, &QLineEdit::textChanged, this,
                          &GraphConfigurationDialog::x2MinRangeChanged);
      QObject::disconnect(this->x2max, &QLineEdit::textChanged, this,
                          &GraphConfigurationDialog::x2MaxRangeChanged);
    ...
    void GraphConfigurationDialog::y2MinRangeChanged(const QString& v) {
      QObject::disconnect(&(this->graph), &Graph::y2RangeChanged, this,
                          &GraphConfigurationDialog::graphY2RangeChanged);
      bool b;
      qreal vmin;
      qreal vmax;
    ...
    void GraphConfigurationDialog::graphY2RangeChanged(const qreal vmin,
                                                       const qreal vmax) {
      QObject::disconnect(this->y2min, &QLineEdit::textChanged, this,
                          &GraphConfigurationDialog::y2MinRangeChanged);
      QObject::disconnect(this->y2max, &QLineEdit::textChanged, this,
                          &GraphConfigurationDialog::y2MaxRangeChanged);
    ...
    QWidget* GraphConfigurationDialog::createTitlesPage() {
      ...
      QObject::connect(&(this->graph), &Graph::upperTitleChanged, this,
                       &GraphConfigurationDialog::graphUpperTitleChanged);
      QObject::connect(this->utle, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::upperTitleChanged);
      grid->addWidget(new QLabel(tr("Down title")), 1, 0);
      grid->addWidget(this->dtle, 1, 1);
      QObject::connect(&(this->graph), &Graph::downTitleChanged, this,
                       &GraphConfigurationDialog::graphDownTitleChanged);
      QObject::connect(this->dtle, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::downTitleChanged);
      grid->addWidget(new QLabel(tr("Left title")), 2, 0);
      grid->addWidget(this->ltle, 2, 1);
      QObject::connect(&(this->graph), &Graph::leftTitleChanged, this,
                       &GraphConfigurationDialog::graphLeftTitleChanged);
      QObject::connect(this->ltle, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::leftTitleChanged);
      grid->addWidget(new QLabel(tr("Right title")), 3, 0);
      grid->addWidget(this->rtle, 3, 1);
      QObject::connect(&(this->graph), &Graph::rightTitleChanged, this,
                       &GraphConfigurationDialog::graphRightTitleChanged);
      QObject::connect(this->rtle, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::rightTitleChanged);
      titles->setLayout(grid);
      return titles;
    }

    void GraphConfigurationDialog::graphXLabelChanged(const QString& l) {
      QObject::disconnect(this->xle, &QLineEdit::textChanged, this,
                          &GraphConfigurationDialog::xLabelChanged);
      this->xle->setText(l);
      QObject::connect(this->xle, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::xLabelChanged);
    ...
    void GraphConfigurationDialog::xLabelChanged(const QString& l) {
      QObject::disconnect(&(this->graph), &Graph::xLabelChanged, this,
                          &GraphConfigurationDialog::graphXLabelChanged);
    ...
    void GraphConfigurationDialog::graphX2LabelChanged(const QString& l) {
      QObject::disconnect(this->x2le, &QLineEdit::textChanged, this,
                          &GraphConfigurationDialog::x2LabelChanged);
      this->x2le->setText(l);
      QObject::connect(this->x2le, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::x2LabelChanged);
    ...
    void GraphConfigurationDialog::x2LabelChanged(const QString& l) {
      QObject::disconnect(&(this->graph), &Graph::x2LabelChanged, this,
                          &GraphConfigurationDialog::graphX2LabelChanged);
    ...
    void GraphConfigurationDialog::graphYLabelChanged(const QString& l) {
      QObject::disconnect(this->yle, &QLineEdit::textChanged, this,
                          &GraphConfigurationDialog::yLabelChanged);
      this->yle->setText(l);
      QObject::connect(this->yle, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::yLabelChanged);
    ...
    void GraphConfigurationDialog::yLabelChanged(const QString& l) {
      QObject::disconnect(&(this->graph), &Graph::yLabelChanged, this,
                          &GraphConfigurationDialog::graphYLabelChanged);
    ...
    void GraphConfigurationDialog::graphY2LabelChanged(const QString& l) {
      QObject::disconnect(this->y2le, &QLineEdit::textChanged, this,
                          &GraphConfigurationDialog::y2LabelChanged);
      this->y2le->setText(l);
      QObject::connect(this->y2le, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::y2LabelChanged);
    ...
    void GraphConfigurationDialog::y2LabelChanged(const QString& l) {
      QObject::disconnect(&(this->graph), &Graph::y2LabelChanged, this,
                          &GraphConfigurationDialog::graphY2LabelChanged);
    ...
    void GraphConfigurationDialog::upperTitleChanged(const QString& l) {
      QObject::disconnect(&(this->graph), &Graph::upperTitleChanged, this,
                          &GraphConfigurationDialog::graphUpperTitleChanged);
    ...
    void GraphConfigurationDialog::graphUpperTitleChanged(const QString& l) {
      QObject::disconnect(this->utle, &QLineEdit::textChanged, this,
                          &GraphConfigurationDialog::upperTitleChanged);
      this->utle->setText(l);
      QObject::connect(this->utle, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::upperTitleChanged);
    ...
    void GraphConfigurationDialog::downTitleChanged(const QString& l) {
      QObject::disconnect(&(this->graph), &Graph::downTitleChanged, this,
                          &GraphConfigurationDialog::graphDownTitleChanged);
    ...
    void GraphConfigurationDialog::graphDownTitleChanged(const QString& l) {
      QObject::disconnect(this->dtle, &QLineEdit::textChanged, this,
                          &GraphConfigurationDialog::downTitleChanged);
      this->dtle->setText(l);
      QObject::connect(this->dtle, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::downTitleChanged);
    ...
    void GraphConfigurationDialog::leftTitleChanged(const QString& l) {
      QObject::disconnect(&(this->graph), &Graph::leftTitleChanged, this,
                          &GraphConfigurationDialog::graphLeftTitleChanged);
    ...
    void GraphConfigurationDialog::graphLeftTitleChanged(const QString& l) {
      QObject::disconnect(this->ltle, &QLineEdit::textChanged, this,
                          &GraphConfigurationDialog::leftTitleChanged);
      this->ltle->setText(l);
      QObject::connect(this->ltle, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::leftTitleChanged);
    ...
    void GraphConfigurationDialog::rightTitleChanged(const QString& l) {
      QObject::disconnect(&(this->graph), &Graph::rightTitleChanged, this,
                          &GraphConfigurationDialog::graphRightTitleChanged);
    ...
    void GraphConfigurationDialog::graphRightTitleChanged(const QString& l) {
      QObject::disconnect(this->rtle, &QLineEdit::textChanged, this,
                          &GraphConfigurationDialog::rightTitleChanged);
      this->rtle->setText(l);
      QObject::connect(this->rtle, &QLineEdit::textChanged, this,
                       &GraphConfigurationDialog::rightTitleChanged);
