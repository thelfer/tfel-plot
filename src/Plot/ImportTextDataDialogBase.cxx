...
namespace tfel {
  ...
  namespace plot {
    ...
    unsigned short ImportTextDataDialogBase::convertToUnsignedShort(
    ...
    void ImportTextDataDialogBase::createGUI() {
      ...
      hl->addWidget(ib);
      hl->addWidget(ib2);
      QObject::connect(&g, &Graph::destroyed, this,
                       &ImportTextDataDialogBase::close);
      QObject::connect(cb, &QPushButton::pressed, this,
                       &ImportTextDataDialogBase::close);
      QObject::connect(ib, &QPushButton::pressed, this,
                       &ImportTextDataDialogBase::import);
      QObject::connect(ib2, &QPushButton::pressed, this,
    ...
    void ImportTextDataDialogBase::currentAbscissaIndexChanged(int i) {
      QObject::disconnect(this->a, &QLineEdit::textChanged, this,
                          &ImportTextDataDialogBase::abscissaChanged);
      if (this->afirst) {
    ...
    void ImportTextDataDialogBase::currentOrdinateIndexChanged(int i) {
      QObject::disconnect(this->o, &QLineEdit::textChanged, this,
                          &ImportTextDataDialogBase::ordinateChanged);
      if (this->ofirst) {
      ...
      if (!this->userDefinedKey) {
        QObject::disconnect(this->ke, &QLineEdit::textChanged, this,
                            &ImportTextDataDialogBase::keyChanged);
    ...
    ImportTextDataDialogBase::operator bool() const { return this->ok; }
