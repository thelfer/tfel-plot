...
struct GnuplotInterpreterTest final : public tfel::tests::TestCase {
  GnuplotInterpreterTest()
      : tfel::tests::TestCase("TFEL/Plot", "GnuplotInterpreterTest") {
 ...
 private:
  ...
  QString parse(tfel::plot::GnuplotInterpreter& i,
                const char* const s,
...
TFEL_TESTS_GENERATE_PROXY(GnuplotInterpreterTest, "GnuplotInterpreterTest");
